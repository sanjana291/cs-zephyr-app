...
const uint8_t dcd_data[] = {
	...
	/* #1.119, command: write_value, address: SEMC_BMCR0, value: 0x0, size: 4 */
	0x40, 0x0D, 0x40, 0x08, 0x00, 0x00, 0x00, 0x00,
	/* #1.120, command: write_value, address: SEMC_BMCR1, value: 0x81, size: 4 */
	0x40, 0x0D, 0x40, 0x0C, 0x00, 0x00, 0x00, 0x81,
	/* #1.121, command: write_value, address: SEMC_BR0, value: 0x80000019, size: 4 */
	0x40, 0x0D, 0x40, 0x10, 0x80, 0x00, 0x00, 0x19,
	/* #1.122, command: write_value, address: SEMC_SDRAMCR0, value: 0xFA1, size: 4 */
	0x40, 0x0D, 0x40, 0x40, 0x00, 0x00, 0x0F, 0xA1,
	/* #1.123, command: write_value, address: SEMC_SDRAMCR1, value: 0x693311, size: 4 */
	0x40, 0x0D, 0x40, 0x44, 0x00, 0x69, 0x33, 0x11,
	/* #1.124, command: write_value, address: SEMC_SDRAMCR2, value: 0x9090B, size: 4 */
	0x40, 0x0D, 0x40, 0x48, 0x00, 0x09, 0x09, 0x0B,
	/* #1.125, command: write_value, address: SEMC_SDRAMCR3, value: 0x3D06, size: 4 */
	0x40, 0x0D, 0x40, 0x4C, 0x00, 0x00, 0x3D, 0x06,
